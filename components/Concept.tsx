    ...
    >
      ...
      >
        ...
        <p className="text-xs text-neutral-500">
          你好，我对新品牌形象设计有几点要求：现代感、专业性，同时要体现创新精神。我们注重环保，所以希望蓝色和绿色能成为主色调。我希望能在下周三前看到初步设计。
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">好的亲，我们会在下周三前提供几个设计方案供您审阅。</p>
        <Image
